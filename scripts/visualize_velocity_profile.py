...
# This small script subscribes to the FeedbackMsg message of my_teb_local_planner
...
import rospy, math
from my_teb_local_planner.msg import FeedbackMsg, TrajectoryMsg, TrajectoryPointMsg
...
def velocity_plotter():
  ...
  rospy.loginfo("Make sure to enable rosparam 'publish_feedback' in the my_teb_local_planner.")
